 ...
 * - 支持按资源类型过滤
 */
export async function getUserPermissions(resourceType?: string): Promise<ApiResponse<string[]>> {
 ...
 * - 强制用户在该设备上重新登录
 */
export async function revokeSession(sessionId: string): Promise<ApiResponse<any>> {
