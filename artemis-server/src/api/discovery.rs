...
use artemis_service::discovery::LoadBalanceStrategy;
use artemis_service::traits::DiscoveryService;
use axum::{
    Json,
    extract::{Query, State},
    http::StatusCode,
...
#[cfg(test)]
mod tests {
    use artemis_common::model::{DiscoveryConfig, GetServiceRequest, GetServicesRequest};
