...
| 功能 | Task | 状态 | 说明 |
|------|------|------|------|
| **配置扩展** | Task 1 | 📋 计划 | 支持所有企业级配置项 |
| **多地址管理** | Task 2 | 📋 计划 | 自动发现、随机负载均衡 |
| **HTTP 重试** | Task 3 | 📋 计划 | 可配置重试次数和间隔 |
| **心跳 TTL 检查** | Task 4 | 📋 计划 | 超时检测和自动重连 |
| **WebSocket 健康检查** | Task 5 | 📋 计划 | Ping/Pong 机制 |
| **缓存 TTL 管理** | Task 6 | 📋 计划 | 服务缓存自动过期 |

### P1 功能 (强烈建议)

| 功能 | Task | 状态 | 说明 |
|------|------|------|------|
| **失败重试队列** | Task 7 | 📋 计划 | 失败请求自动重试 |
| **注册过滤器链** | Task 8 | 📋 计划 | 可组合的实例过滤 |
| **Prometheus 监控** | Task 9 | 📋 计划 | 完整的度量指标 |
| **批量服务查询** | Task 10 | 📋 计划 | 批量查询优化 |

### P2 功能 (可选)

| 功能 | Task | 状态 | 说明 |
|------|------|------|------|
| **WebSocket 取消订阅** | Task 11 | 📋 计划 | 动态订阅管理 |
| **集成测试和文档** | Task 12 | 📋 计划 | 完整的测试和文档 |
...
- [ ] 扩展 ClientConfig 并添加验证
- [ ] 实现 AddressManager 地址管理
- [ ] 实现 HTTP 重试机制
- [ ] 添加心跳 TTL 检查
